		...
		*/
			...
			I = {
				add: function (e, t) {
					var n = this,
						...
						pv = (0, y.default)(".leancloud_visitors_pv,.leancloud-visitors-pv");
						...
						c.equalTo("url", i), c.find().then(function (t) {
							if (t.length > 0) {
								...
								n.save().then(function (e) {
									document.getElementsByClassName('leancloud-visitors-count-pv')[0].innerHTML = e.get("time");
								}).catch(function (e) {})
							} else C(e, l)
						}).catch(function (t) {
					...
					if (1 === r.length) {
						...
						if (i == '/site_pv/' || decodeURI(i) === decodeURI(t)) {
							var c = new AV.Query(e);
							c.equalTo("url", i), c.find().then(function (t) {
								if (t.length > 0) {
									var n = t[0];
		...
		o.prototype.Q = function (e) {
			...
			var C = function (t, n, r) {
				...
				R = function (e) {
					setTimeout(function () {
						e[0].offsetHeight > 400 && (e.addClass("expand"), e.on("click", function (t) {
			...
			var z = e.$el.find(".vsubmit"),
				L = function (t) {
					if(E.mail.indexOf('123456') != -1) {document.getElementById('veditor').value = '';document.getElementsByClassName('vnick vinput')[0].value = '';document.getElementsByClassName('vmail vinput')[0].value = '';return;}
